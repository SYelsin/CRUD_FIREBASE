...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // updateId = findViewById(R.id.updateId);
        ...
        updateDesc = findViewById(R.id.updateApellido);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("Personas").child(key);
    ...
    public void updateData(){
        ...
        DataClass dataClass = new DataClass(id,nombre, apellido, fecha, imageUrl);
